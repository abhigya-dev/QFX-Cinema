...
const Footer = () => {
  return (
   <footer className="px-6 pt-8 md:px-16 lg:px-36 w-full text-gray-300 lg:pt-20 overflow-hidden">
                ...
                <div className="flex-1 flex items-start md:justify-end gap-20 md:gap-40">
                    ...
                    <div>
                        ...
                        <div className="text-sm space-y-2">
                            <p>+91-7303228196</p>
                            <p>abhigyasapkota.dev@gmail.com</p>
                        </div>
                    </div>
                </div>
            </div>
            <p className="pt-4 text-center text-sm pb-5">
                Copyright {new Date().getFullYear()} © <a href="#">Made with ❤️ by Abhigya Sapkota</a>. All Right Reserved.
            </p>
        </footer>
  )
}
